...
router.post('/register', requireGuest, validateRegistration, async (req, res) => {
    ...
    try {
        ...
        database.checkUserExists(username, email, (err, existingUser) => {
            if (err) {
            ...
            bcrypt.hash(password, 10, (hashErr, hashedPassword) => {
                ...
                database.createUser(username, email, hashedPassword, (createErr, userId) => {
                    if (createErr) {
...
router.post('/login', requireGuest, validateLogin, (req, res) => {
...
router.get('/user', requireAuth, (req, res) => {
    ...
    database.getUserById(req.session.userId, (err, user) => {
        if (err) {
