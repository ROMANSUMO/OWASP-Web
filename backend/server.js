...
logger.info('� Powered by Supabase authentication');

console.log('🚀 Starting WebSecurity Backend Server...');
console.log('� Powered by Supabase authentication');
...
app.listen(PORT, () => {
    ...
    console.log('💡 Frontend uses Supabase client directly - backend provides additional API support');
});
